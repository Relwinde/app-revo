...
class EditFacture extends Component
{
    ...
    public function mount(FactureProforma $facture){
        ...
        $this->client_id = $this->factureProforma->client_id;
        $this->date = $this->factureProforma->date;
        $this->payment_terms = $this->factureProforma->payment_terms;
    ...
    public function render()
    {
        $pageHeader = [
            ...
            'subtitle' => 'Détails de la facture pro-forma',
            'breadcrumbs' => [
                ['label' => 'Accueil', 'url' => route('home')],
                ['label' => 'Factures Pro-Forma', 'url' => route('facture-proformas')],
                ['label' => 'Détails de la facture pro-forma'],
                ],
                ];
        ...
        return view('livewire.facture-proforma.edit-facture', compact('pageHeader', 'clients', 'chauffeurs', 'camions'))->layout('components.layouts.app', ['title' => 'Détails de la Facture Pro-Forma']);
    }
