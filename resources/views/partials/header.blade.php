        ...
        <div class="dropdown d-inline-block ml-2">
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                ...
                <div class="p-2">
                    ...
                    <button onclick="Livewire.dispatch('openModal', { component: 'user.modals.update-user' })" class="dropdown-item d-flex align-items-center justify-content-between">
                        <span class="font-size-sm font-w500">Modifier mes infos </span>
                    </button>
