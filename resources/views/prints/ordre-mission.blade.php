<div>
    ...
    <table style="width: 100%; margin-top: 25px;">
        ...
        <tbody style="text-align: center; width: 100%;">
            <tr>
                ...
                <th style=" width: 40%; text-align: left; color: red;" >
                    {{ $dossier->numero }}
                </th>
            </tr>
        </tbody>
    ...
    <div style="margin: 20px; width: 100%;">
        <span style="text-align: right; width:100%; "> Ouagadougou  </span>
    </div>

    <div style="margin-top: 20px; margin-right: 0px; margin-bottom: 20px; margin-left: 5px;">Messieurs</div>
